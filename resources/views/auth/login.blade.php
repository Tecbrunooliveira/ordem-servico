...
<head>
    ...
    <title>Login — {{ config('navigation.brand.name') }}</title>
                    ...
                    <div class="login-brand">
                        <div class="login-brand-mark">
                            @if (! empty($empresa['logo']))
                                <img src="{{ $empresa['logo'] }}" alt="{{ $nomeMarca }}">
                            @else
                        ...
                        <div class="login-brand-text">
                            <p class="login-brand-name">{{ config('navigation.brand.name') }}</p>
                            <p class="login-brand-subtitle">{{ config('navigation.brand.subtitle') }}</p>
                        </div>
                    </div>
                ...
                <div class="login-side-content">
                    <div class="login-illustration-wrap">
                        <div class="login-illustration">
                            <img
                                src="{{ asset('images/login/sign-in-rafiki.svg') }}"
                                alt="Ilustração de acesso ao sistema"
                            >
                        </div>
                        <a href="https://storyset.com/user" target="_blank" rel="noopener noreferrer" class="login-storyset">
